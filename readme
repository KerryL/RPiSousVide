...
5.  Build RPiSousVide using the included make file (make changes as appropriate if you didn't exactly follow the instructions above), and copy to your Raspberry Pi.
