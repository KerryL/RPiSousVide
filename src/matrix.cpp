...
//
// Description:		Constant definitions for Matrix class.
//
// Input Arguments:
//		None
//
...
//
//==========================================================================
const double Matrix::nearlyZero = 1.0e-15;
...
unsigned int Matrix::GetRank(void) const
{
	...
	for (curRow = 0; curRow < rows; curRow++)
	{
		...
		{
			if (!IsZero(elements[curRow][curCol]))
			{
...
// Function:		IsZero
//
// Description:		Method for determining if a value is nearly zero.
//
// Input Arguments:
//		value	= const double&
//
...
//
// Return Value:
//		bool, true for nearly zero, false otherwise
//
//==========================================================================
bool Matrix::IsZero(const double &value)
{
