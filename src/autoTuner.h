...
//   H(t)  = power generated by heater           [BTU/sec]
...
// two bulk parameters (plus one expression for H(t)):
//   c1   = h * A / (rho * V * Cp)     [1/sec]
//   c2   = 1 / (rho * V * Cp)         [deg F/BTU]
//   H(t) = Hcmd * (1 - exp(-t / tau)) [BTU/sec]
//
// where tau is the time constant for the model of the heating element, in
// [sec].
//
